...
/*   Updated: 2025/02/19 21:34:23 by nagaudey         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (data->img.form == '1')
		mlx_put_image_to_window(data->mlx_ptr, data->win_ptr, data->img.player_1,
		data->pos.x * IMG_WIDTH, data->pos.y * IMG_HEIGHT);
	else if (data->img.form == '2')
		mlx_put_image_to_window(data->mlx_ptr, data->win_ptr, data->img.player_2,
		data->pos.x * IMG_WIDTH, data->pos.y * IMG_HEIGHT);
	else if (data->img.form == 'G')
		mlx_put_image_to_window(data->mlx_ptr, data->win_ptr, data->img.player_G,
		data->pos.x * IMG_WIDTH, data->pos.y * IMG_HEIGHT);
	else if (data->img.form == 'D')
		mlx_put_image_to_window(data->mlx_ptr, data->win_ptr, data->img.player_D,
		data->pos.x * IMG_WIDTH, data->pos.y * IMG_HEIGHT);
}
...
{
	if (data->img.form == 'S')
		mlx_put_image_to_window(data->mlx_ptr, data->win_ptr, data->img.player_S,
		data->pos.x * IMG_WIDTH, data->pos.y * IMG_HEIGHT);
	else if (data->img.form == 'L')
		mlx_put_image_to_window(data->mlx_ptr, data->win_ptr, data->img.player_L,
		data->pos.x * IMG_WIDTH, data->pos.y * IMG_HEIGHT);
	else if (data->img.form == 'R')
		mlx_put_image_to_window(data->mlx_ptr, data->win_ptr, data->img.player_R,
		data->pos.x * IMG_WIDTH, data->pos.y * IMG_HEIGHT);
	ft_put_player(data);
}
